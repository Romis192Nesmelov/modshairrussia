...
$routes->get('la_french', 'Pages::la_french');
$routes->get('smart_haircut', 'Pages::smart_haircut');
$routes->get('blog', 'Pages::blog');
$routes->get('blog/(:any)', 'Pages::article/$1');
$routes->get('woman_haircut', 'Pages::woman_haircut');
$routes->get('man_haircut', 'Pages::man_haircut');
$routes->get('staining', 'Pages::staining');
