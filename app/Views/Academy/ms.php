...
<!--                <h2 class="big template_ms__form__title">--><?php //= !empty($service['ms']['form_title']) ? $service['ms']['form_title'] : 'Получить расписание тренингов'; ?><!--</h2>-->
...
<!--                <p style="font-size: 11px; font-style: italic">Нажимая кнопку “Отправить”, я даю согласие на обработку и хранение персональных данных и соглашаюсь с <a href="--><?php //= base_url(); ?><!--/media/policy_mods.pdf" style="text-decoration: underline dotted;" target="_blank">политикой конфиденциальности</a> </p>-->
