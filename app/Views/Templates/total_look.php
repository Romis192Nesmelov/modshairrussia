            ...
            <div class="sanity_slider__content">
                <?php $looks = [
                    [
                        ...
                        'title' => 'Образ Росси',
                        'list' => [
                            ['title' => 'Окрашивание mod’s hair в технике Glossing', 'sub_title' => '(окрашивание, которое придает плавные переходы, натуральный оттенок и мягкий глянцевый блеск)', 'text' => 'благодаря чередованию оттенков, локоны выглядят рельефно'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'sub_title' => '(стрижка без укладки)', 'text' => 'Каре с локонами. Чёлка достаточно короткая, чтобы сфокусировать внимание на выражении глаз.'],
                            ['title' => 'Укладка', 'text' => 'Чтобы ещё больше подчеркнуть красоту кудрей, слегка проработайте их при помощи щипцов. Нанесите на локоны Crème de Boucles modёs hair для увлажнения и дополнительного блеска. При помощи мусса Légère modёs hair придайте причёске слегка растрёпанный вид'],
                        ]
                    ],
                    [
                        'type' => 'woman',
                        ...
                        'title' => 'Образ Индия',
                        'list' => [
                            ['title' => 'Окрашивание mod’s hair в технике L`Intensurfer mod`s hair', 'sub_title' => '(окрашивание, которое дает выраженный и яркий эффект выгоревших на солнце волос с контрастными акцентами)', 'text' => 'Красоту балаяжа в золотисто-бежевых оттенках подчёркивают волны'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'sub_title' => '(стрижка без укладки)', 'text' => 'Красивая градуированная стрижка на длинные волосы'],
                            ['title' => 'Укладка', 'text' => 'Чтобы укладка выглядела естественно, перед тем как начать брашинг, нанесите на волосы спрей Sel Marin modёs hair. Для придания яркого блеска используйте спрей Nutri Shine modёs hair'],
                        ]
                    ],
                    [
                        'type' => 'woman',
                        ...
                        'title' => 'Образ Милин',
                        'list' => [
                            ['title' => 'Окрашивание mod’s hair в технике Surfer Contouring', 'sub_title' => '(создаёт рельефность около лица, обрамляя и оттеняя его)', 'text' => 'Контуринг с прядями тёплых оттенков выгодно оттеняет овал лица'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'sub_title' => '(стрижка без укладки)', 'text' => 'Эта стрижка на длинные волосы с ярко выраженной градуировкой добавляет волосам динамики и делает образ мягким.'],
                            ['title' => 'Укладка', 'text' => 'Крем Brushing modёs hair поможет в укладке: чтобы добиться объёма в стиле звёзд 80-х, волосы должны быть очень тщательно уложены брашингом.'],
                        ]
                    ],
                    [
                        'type' => 'woman',
                        ...
                        'title' => 'Образ Дэбби',
                        'list' => [
                            ['title' => 'Окрашивание mod’s hair Surfer Babylight', 'sub_title' => '(легкий и естественный переход цвета, придает волосам мягкий объем. Волосы выглядят светлее, но без резких контрастов)', 'text' => 'Сияние подчёркивает тонкий узор балаяжа и его характер «Высокой моды»'],
                            ['title' => 'Шампунь и уход', 'text' => 'Уход за кожей головы и типу волос'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'sub_title' => '(стрижка без укладки)', 'text' => 'Французское каре средней длины с неровно простриженной верхней частью. Форма усовершенствована за счет длинной пряди, обрамляющей лицо. '],
                    ...
                    [
                        ...
                        'list' => [
                            ['title' => 'Шампунь и уход', 'text' => 'Уход за кожей головы и типу волос'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'sub_title' => '(стрижка без укладки)', 'text' => 'Градуированная стрижка с челкой'],
                    ...
                    [
                        ...
                        'title' => 'Образ Рита',
                        'list' => [
                            ['title' => 'Окрашивание mod’s hair в технике балаяж Soft Surfer', 'sub_title' => '(эффект, который создает теплое, солнечное сияние. Волосы выглядят будто они мягко выгорели на солнце)', 'text' => 'Лёгкий и естественный, он играет на волосах с разных сторон.'],
                            ['title' => 'Шампунь и уход', 'text' => 'Уход за кожей головы и типу волос'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'sub_title' => '(стрижка без укладки)', 'text' => 'Каре на длинные волосы с ярко выраженной структурой'],
                    ...
                    [
                        ...
                        'list' => [
                            ...
                            ['title' => 'Шампунь и уход', 'text' => 'Уход за кожей головы и типу волос'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'sub_title' => '(стрижка без укладки)', 'text' => 'Стрижка выполняется на сухие волосы без разделений '],
                    ...
                    [
                        ...
                        'list' => [
                            ...
                            ['title' => 'Шампунь и уход', 'text' => 'Уход за кожей головы и типу волос'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'sub_title' => '(стрижка без укладки)', 'text' => 'Стрижка с градуировкой выполняется  при помощи машинки или в технике ножницы на расчёске'],
                    ...
                    [
                        ...
                        'title' => 'Образ Пегги',
                        'list' => [
                            ['title' => 'Окрашивание mod’s hair балаяж  Surfer Contouring mod`s hair', 'sub_title' => '(создаёт рельефность около лица, обрамляя и оттеняя его)', 'text' => 'В персиковых оттенках, которые выгодно подсвечивают лицо'],
                            ['title' => 'Шампунь и уход', 'text' => 'Уход за кожей головы и типу волос'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'sub_title' => '(стрижка без укладки)', 'text' => 'Стрижка на длинные волосы с лёгкой градуировкой и мягкой укладкой.'],
                    ...
                    [
                        ...
                        'title' => 'Образ Клэр',
                        'list' => [
                            ['title' => 'Окрашивание mod\'s hair Intensurfer gold', 'sub_title' => '(окрашивание, которое дает выраженный и яркий эффект выгоревших на солнце волос с контрастными акцентами)', 'text' => 'Легкая вуаль и блики разных оттенков;'],
                            ['title' => 'Уход от L’Oréal Professionnel', 'text' => 'Укрепление и защита волос;'],
                            ['title' => 'Шампунь и уход', 'text' => 'Уход за кожей головы и типу волос;'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'sub_title' => '(стрижка без укладки)', 'text' => 'Мягкая форма каре для объема и легкости.']
                        ]
                    ],
                    [
                        'type' => 'woman',
                        ...
                        'title' => 'Образ Кейт',
                        'list' => [
                            ['title' => 'Окрашивание balayage', 'sub_title' => '(эффект выгоревших на солнце волос. Как правило в тёплых оттенках)', 'text' => 'Игра света и тени, выгодно подчеркнёт черты лица;'],
                            ['title' => 'Тонирование', 'text' => 'Придаст волосам блеск и усилит оттенок;'],
                            ['title' => 'Уход от L’Oréal Professionnel', 'text' => 'Укрепление и защита волос;'],
                            ['title' => 'Шампунь и уход', 'text' => 'Уход за кожей головы и типу волос;'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'sub_title' => '(стрижка без укладки)', 'text' => 'Градуированная стрижка на средние и длинные волосы придаст дополнительный объем и добавит легкости.']
                        ]
                    ],
                    [
                        'type' => 'woman',
                        ...
                        'list' => [
                            ...
                            ['title' => 'Уход от L’Oréal Professionnel', 'text' => 'Укрепление и защита волос;'],
                            ['title' => 'Шампунь и уход', 'text' => 'Уход за кожей головы и типу волос;'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'sub_title' => '(стрижка без укладки)', 'text' => ''],
                    ...
                    [
                        ...
                        'list' => [
                            ...
                            ['title' => 'Уход от L’Oréal Professionnel', 'text' => 'Укрепление и защита волос;'],
                            ['title' => 'Шампунь и уход', 'text' => 'Уход за кожей головы и типу волос;'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'sub_title' => '(стрижка без укладки)', 'text' => 'Каре с легким удлинением к лицу.'],
                        ]
                    ],
                    [
                        'type' => 'man',
                    ...
                    [
                        ...
                        'title' => 'Образ Белла',
                        'list' => [
                            ['title' => 'Техника обратного среза backcutting', 'sub_title' => '(техника, при которой волосы срезаются не по прямой линии, а под углом)', 'text' => 'Создает текстуру, придает волосам лёгкость и растрёпанный стиль;'],
                    ...
                    [
                        ...
                        'list' => [
                            ...
                            ['title' => 'Знаменитый стиль укладки décoiffé', 'sub_title' => '(без укладки)', 'text' => 'Придаёт стрижке элемент сексуальности;'],
                    ...
                    [
                        ...
                        'list' => [
                            ...
                            ['title' => 'Балаяж в технике Twinsurfer mod’s hair', 'sub_title' => '(техника, которая придает яркий блонд с более чёткими светлыми прядями)', 'text' => 'Создаёт яркий контраст и рельефность;'],
                                ...
                                <ul class="template_total-look__slider__item__content__list">
                                    <?php foreach ($item['list'] as $li) : ?>
                                        <li class="template_total-look__slider__item__content__list__item">
                                            <p class="template_total-look__slider__item__content__list__item__title"><?= $li['title']; ?></p><?= !empty($li['sub_title']) ? '<p class="sub_title">'.$li['sub_title'].'</p>' : ''; ?>
